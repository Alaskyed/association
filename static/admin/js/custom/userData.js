    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == '0') {
                ...
                $("#userDataPhoneNumberChangeSubmit").css("display", "none");
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == '0') {
                ...
                $("#userDataEmailChangeSubmit").css("display", "none");
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == '0') {
                ...
                $("#userDataQqChangeSubmit").css("display", "none");
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == '0') {
                ...
                $("#userDataWechatChangeSubmit").css("display", "none");
